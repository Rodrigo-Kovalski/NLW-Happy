...
export default function CreateOrphanage() {
  ...
  const [position, setPosition] = useState({latitude: 0, longitute: 0});
  ...
  async function  handleSubmit(event: FormEvent){
    ...
    const {latitude, longitute} = position;
    ...
    data.append('longitude',String(longitute));
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            >
              ...
              {position.latitude !== 0 ? (
                <Marker interactive={false} icon={happyMapIcon} position={[position.latitude,position.longitute]} />
              ) : null }
